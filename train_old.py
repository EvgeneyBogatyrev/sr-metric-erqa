...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=Path, default="C:/SR/code/paper_metric_dataset/SR_dataset_subjective/dataset")
...
def main():
    ...
    datamodule = DataModule(args.dataset_path, "./subjective_scores.json", "./banned_frames.json")
